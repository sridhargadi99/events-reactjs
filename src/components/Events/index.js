...
class Events extends Component {
  state = {
    activeState: 'Initial_State',
  }

  stateUpdate = registrationStatus =>
    this.setState({activeState: registrationStatus})
    ...
    return (
      <div className="bg-container">
        <div className="events-container">
          <h1 className="events-heading-style">Events</h1>
        ...
        <ActiveEventRegistrationDetails activeStateDetails={activeState} />
      </div>
    )
  }
}
